table 50060 "Loading Sheet Header"
{
    ...
    fields
    {
        ...
        field(19;"Airline Code";Code[20])
        {
            ...
            trigger OnValidate()
            begin
                IF "Airline Code"<>xRec."Airline Code" THEN
                BEGIN
                "Flight Code":='';
                "Destination Code":='';
                END;
        ...
        field(25;"Loading Sheet MAWB No";Code[50])
        {
            ...
            trigger OnValidate()
            begin
                IF "Loading Sheet MAWB No"<>xRec."Loading Sheet MAWB No"  THEN
                BEGIN
                  IF CONFIRM('Do you want to update the MAWB Numbers') THEN
                  BEGIN
                    ...
                    IF LoadingSheetLines.FIND('-') THEN
                    BEGIN
                      MESSAGE('Found');
    ...
    begin
        WITH LoadingSheetHeader DO BEGIN
          ...
          IF NoSeriesMgt.SelectSeries(ImportExportSetup."Loading Sheet Nos.",OldLoadingSheetHeader."No. Series","No. Series") THEN BEGIN
            ImportExportSetup.GET;
            ImportExportSetup.TESTFIELD("Loading Sheet Nos.");
    ...
    begin
        ...
        IF ShippedBoxes = ReceivedBoxes THEN
        BEGIN
        State:=TRUE;
