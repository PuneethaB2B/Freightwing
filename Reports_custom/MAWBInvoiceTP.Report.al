    ...
    dataset
    {
        dataitem(DataItem1; Table36)
        {
            ...
            dataitem(DataItem9; Table37)
            {
                ...
                column(AgreedRate_SalesLine; "Sales Line"."Agreed Rate")
                {
                }
                column(Totalweight_SalesLine; "Sales Line"."Total weight")
                {
                }
                ...
                column(Item_Code_Description; ShortcutDimCode[3])
                {
                }
                ...
                begin
                    ...
                    END;
                    Dinset.SETRANGE(Dinset."Dimension Set ID", "Sales Line"."Dimension Set ID");
                    IF Dinset.FINDLAST THEN
                        DimText := Dinset."Dimension Value Code";
                    TotalWeight := "Sales Header"."Total Weight"; // was from the sales line
