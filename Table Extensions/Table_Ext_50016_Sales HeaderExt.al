tableextension 50016 SalesHeaderExt extends "Sales Header"
{
    fields
    {
    ...
    begin
        ...
        IF PurchInvLine.FINDFIRST THEN BEGIN
            ...
            IF PurchInvHeader."Currency Code" <> ImportExportSetup."Invoicing Currency Code" THEN BEGIN
                ExchangeRates.RESET;
