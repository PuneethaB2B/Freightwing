report 50020 "Daily Weight Distribution"
{
    ...
    var
        ...
        FlightSchedule: Record Flight;
        ETD: Time;
        ULDS: Record "Dl. ULD Allocation By Airline";
        ULDString: Text[250];
        ...
        gRecBookingSheetLineULD: Record "Booking Sheet ULD Allocation";
