report 50122 "Sales - Credit Memo_UPG"
{
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(InvoiceNumber_SalesCrMemoHeader; "Sales Cr.Memo Header"."Invoice Number")
            {
            }
            column(DeiviceCode_SalesCrMemoHeader; "Sales Cr.Memo Header"."Device Code")
            {
            }
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        begin
                            ...
                            HSCode := "Sales Cr.Memo Line".GetHSCode;
