    ...
    dataset
    {
        dataitem("G/L Budget Entry"; "G/L Budget Entry")
        {
            ...
            begin
                ...
                ExcelBuf.CreateNewBook(ExcelBuf.GetExcelReference(10));
                ...
                IF TempPeriod.FIND('-') THEN BEGIN
                    REPEAT
                        ExcelBuf.SetCurrent(HeaderRowNo + 1, NoOfDimensions + 3 + TempPeriod."Period No.");
                        ExcelBuf.StartRange;
                        ExcelBuf.SetCurrent(LastBudgetRowNo, NoOfDimensions + 3 + TempPeriod."Period No.");
                        ExcelBuf.EndRange;
